...
// Last time updated: 2017-06-17 3:15:05 PM UTC
    ...
    function startRecording() {
        ...
        if (mediaRecorder) {
            ...
            if (self.recordingDuration) {
                 console.log('eeeeeeeeeeeeeeeeeee---3:');
        ...
        initRecorder(function() {
             console.log('eeeeeeeeeeeeeeeeeee---4:');
            if (self.recordingDuration) {
                 console.log('eeeeeeeeeeeeeeeeeee---5:');
                handleRecordingDuration();
            }
        });
    console.log('eeeeeeeeeeeeeeeeeee---6:');
        return self;
    }

    function initRecorder(initCallback) {
        console.log('eeeeeeeeeeeeeeeeeee---4.1:');
        if (initCallback) {
            console.log('eeeeeeeeeeeeeeeeeee---4.2:');
            config.initCallback = function() {
                initCallback();
                initCallback = config.initCallback = null; // recorder.initRecorder should be call-backed once.
            };
        }
        console.log('eeeeeeeeeeeeeeeeeee---4.3:');
        var Recorder = new GetRecorderType(mediaStream, config);
         console.log('eeeeeeeeeeeeeeeeeee---4.4:');

        mediaRecorder = new Recorder(mediaStream, config);
        mediaRecorder.record();
        console.log('eeeeeeeeeeeeeeeeeee--mediaRecorder-4.5:',mediaRecorder);

        setState('recording');

        if (!config.disableLogs) {
            console.log('eeeeeeeeeeeeeeeeeee---4.6:');
...
function CanvasRecorder(htmlElement, config) {
    ...
    this.getWebPImages = function(callback) {
        ...
        whammy.frames.forEach(function(frame, idx) {
            ...
            var webp = frame.image.toDataURL('image/webp1', 1);
    ...
    function cloneCanvas() {
        ...
        console.log('newCanvas.width-3185-: ',newCanvas.width);
        newCanvas.height = htmlElement.height;
        console.log('newCanvas.height-3187-: ',newCanvas.height);
    ...
    function drawCanvasFrame() {
        ...
        html2canvas(htmlElement, {
            ...
            onrendered: function(canvas) {
                ...
                whammy.frames.push({
                    image: canvas.toDataURL('image/webp-qhz', 1),
                    duration: duration
                });
...
function WhammyRecorder(mediaStream, config) {
    ...
    this.record = function() {
       ...
       // console.log('canvas.width-----------------------------------------------0629->',canvas.width);
    ...
    function drawFrames(frameInterval) {
        ...
        whammy.frames.push({
            duration: duration,
            image: canvas.toDataURL('image/webp1111111111111111111')
        });
    ...
    function dropBlackFrames(_frames, _framesToCheck, _pixTolerance, _frameTolerance, callback) {
       ...
       // console.log('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee0000000000000000099999999999999999999');
        //console.info('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee0000000000000000099999999999999999999');
...
var Whammy = (function() {
    ...
    WhammyVideo.prototype.add = function(frame, duration) {
        ...
        if ('toDataURL' in frame) {
            frame = frame.toDataURL('image/webpwwwwwwwwwwwwww', this.quality);
        }
...
function MultiStreamRecorder(arrayOfMediaStreams, options) {
    ...
    canvas.style = 'opacity:0;position:absolute;z-index:-1;top: -100000000;left:-1000000000;background:red;';
